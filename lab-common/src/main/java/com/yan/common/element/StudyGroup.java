...
public class StudyGroup implements Comparable<StudyGroup> {
    ...
    public String toString() {
        return "StudyGroup{" + "id = " + id + ", name = '" + name + '\'' + ", coordinates = " + coordinates
                ...
                + ", shouldBeExpelled = " + shouldBeExpelled + ", transferredStudents = " + transferredStudents
                + ", formOfEducation = " + formOfEducation + ", groupAdmin = " + groupAdmin + "}";
    }

    @Override
    public int compareTo(StudyGroup o) {
        if (Objects.equals(this.studentsCount, o.studentsCount)) {
            if (this.formOfEducation == null && o.formOfEducation != null) {
                return -1;
            } else if (this.formOfEducation != null && o.formOfEducation == null) {
                return 1;
            } else {
                return o.shouldBeExpelled.compareTo(this.shouldBeExpelled);
            }
        }
