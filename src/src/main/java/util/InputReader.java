...
public class InputReader {
    ...
    public double readY() {
        ...
        while (y == null) {
            ...
            if (y != null && !validator.checkY(y)) y = null;
        }
        return y;
    }
    ...
    public Integer readStudentsCount() {
        ...
        while (sc == null) {
            ...
            if (sc != null && !validator.checkPositive("studentsCount", sc.longValue())) sc = null;
        }
        return sc;
    }
    ...
    public Integer readShouldBeExpelled() {
        ...
        while (sbe == null) {
            ...
            if (sbe != null && !validator.checkPositive("shouldBeExpelled", sbe.longValue())) sbe = null;
        }
        return sbe;
    }
    ...
    public Long readTransferredStudents() {
        ...
        while (ts == null) {
            ...
            if (ts != null && !validator.checkPositive("transferredStudents", ts)) ts = null;
        }
        return ts;
    }
    ...
    public Person readPerson() {
        ...
        while (ans == null) {
            ...
            if (!ans.toUpperCase(Locale.ROOT).equals("YES") && !ans.toUpperCase(Locale.ROOT).equals("NO")) ans = null;
        }
        if (ans.toUpperCase(Locale.ROOT).equals("NO")) return null;
