...
public class FileHandler {
    ...
    public FileHandler(String filePath) throws FileNotFoundException {
        ...
        if (!file.canRead() || !file.canWrite()) throw new SecurityException("!!! Cannot read or write file !!!");
    }
    ...
    public static void writeFile(Map<Integer, StudyGroup> map) throws FileNotFoundException {
        ...
        if (!file.exists()) throw new FileNotFoundException("!!! File not found. Cannot save collection !!!");
        if (!file.canWrite() || !file.canRead()) throw new SecurityException("!!! Cannot write this file. " +
                "Saving collection failed !!!");
        try {
